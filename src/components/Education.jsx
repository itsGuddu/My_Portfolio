...
const Education = () => {
  return (
    <div name='education' className='w-full flex flex-col justify-center items-center h-screen  bg-[#0a192f] text-gray-300'>
    ...
    <div className='py-8'>
      <ol className="relative border-l border-gray-300">                  
        <li className="mb-10 ml-4">
          ...
          <time className="mb-1 text-sm font-normal leading-none text-gray-300 dark:text-gray-500">2009-2018</time>
